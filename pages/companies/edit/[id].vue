        ...
        <div class="card-body p-4 shadow p-3 mb-5 bg-body rounded">
          <div>
            <div class="d-flex justify-content-between">
              <h5 class="card-title mb-5">Atualizar Fornecedor</h5>
            </div>
            <form @submit.prevent="submitCompany" method="post">
              ...
              <div class="col-12">
                ...
                <nuxt-link :to="`/companies`" class="btn btn-secondary"
                  >Cancelar</nuxt-link
                >
              </div>
            </form>
  ...
  methods: {
    ...
    async submitCompany() {
      $fetch(`http://localhost:8443/companies/create`, {
        ...
        .then((res) => {
          console.log("Fornecedor atualizado", res);
    ...
    async getCompany() {
      await useFetch(
        `http://localhost:8443/customers/findById/${this.id_company}`
      ).then((res) => {
